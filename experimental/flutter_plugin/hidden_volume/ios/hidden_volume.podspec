...
Pod::Spec.new do |s|
  ...
  # Four levels up from ios/ is the repo root: ios -> hidden_volume ->
  # flutter_plugin -> experimental -> <root>. Three levels landed on
  # experimental/LICENSE-MIT, which does not exist; CocoaPods does not
  # error on a missing license file, it silently drops the pod from
