...
Branch and PR CI are deliberately not wired (the local release checklist §4), so both of
...
- **[`docs/FLUTTER_INTEGRATION.md`](docs/en/guide/flutter.md)** —
...
- **`hidden-volume-ffi` crate** (v0.8 milestone scaffold). uniffi 0.28
  ...
  [`docs/FFI_DESIGN.md`](docs/en/reference/ffi.md). Build pipeline (iOS
...
- **Public API baseline snapshot** — [`docs/PUBLIC_API_v1.txt`](docs/en/reference/api-surface.txt),
...
### v0.5 closeout
- **fsync ordering audit** ([`docs/FSYNC_AUDIT.md`](docs/en/security/audits/fsync.md)):
